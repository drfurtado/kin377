...
1.  Juggle **3 objects continuously** for at **least `5 seconds`** to receive the full points under the evaluation category of TIME (refer to the @sec-video-performance for this assignment). 

2.  You can **earn 5 extra points** if you continuously juggle 3 objects for at least `10 seconds` (using the correct technique). This points will be used toward the Quizzes category.
...
{{< video https://youtu.be/yAcDYYvXTaA >}}

[Link to open the video](https://youtu.be/yAcDYYvXTaA)

##### STOP & Read: Incorrect techniques that will **NOT be accepted**
...
4.  I've put together a tutorial (@sec-appendix-b) that is meant to help you before and after you start practicing. It is imperative you complete the tutorial before start practicing.
...
{{< video https://youtu.be/OjEH3ugV6mM >}}

[Link to open the video](https://youtu.be/OjEH3ugV6mM)
...
1.  Pick TWO of the [Principles of Motor Learning](#sec-appendix-c) you have been using to learn your selected motor skill (juggling or speed cup stacking).
...
[Reflection Paper Template](https://docs.google.com/document/d/1zp0yN8EAQg6W9ecifHZ8NLonoi3ZMkrI/edit?usp=share_link&ouid=102808224946914322692&rtpof=true&sd=true)
...
[^1]: Substitute YYYY with the year of the edition you are using.

#### Template

I have created [a template](https://docs.google.com/document/d/1zp0yN8EAQg6W9ecifHZ8NLonoi3ZMkrI/edit?usp=share_link&ouid=102808224946914322692&rtpof=true&sd=true) to help you with this assignment. You will be **required** to use the template (see link above) when writing the reflection paper. When using the template:
...
-   IMPORTANT: You will NOT be required to cite sources other than Magill and Anderson (YYYY) and/or Danny (2010). PLEASE, DO NOT CITE MY SLIDES. THE INFORMATION IN THE SLIDES WAS TAKEN FROM @magill2020 and @magill-anderson-2016
...
### Video Performance {#sec-video-performance}
