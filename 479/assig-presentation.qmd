...
format:
  pdf:
    ...
    number-depth: 4
author:
  - name: Ovande Furtado Jr., PhD @ Cal State Northridge
    affiliations:
...
4.  Submissions:
    1.  Topic submission
        1.  The `group's leader` submits three topics for consideration
        2.  The instructor selects a topic and notifies the group
    2.  Video Recording (70 points)
        1.  The `group's leader` submits the recorded presentation (under Discussion) by **April 15 \@ 5pm**.
    3.  Peer Evaluation
        1.  Everyone submits a peer evaluation by **May 13 \@ 5 pm.**
    4.  Peer Engagement (extra credit)
        1.  `Everyone` watches other groups' presentation videos, formulates questions, and submits the questions to the `group's leader` **before April 20**.
            1.  The `group's leader` chooses no more than 5 questions and posts them to their respective submissions (#4.2 above) by **April 29 \@ 5pm**.
            2.  If your group receives questions, an assigned member responds to them by **May 6 \@ 5pm**[^1].

[^1]: The group must coordinate who post the answers, but everyone should be involved in answering them.

## Group Members

Follow [this link](https://canvas.csun.edu/courses/144024/groups) below and log into Canvas, then:
...
Download template[^2]: [Click here to download the PowerPoint file (PPTX)](./assig-presentation-temp.pptx)

[^2]: If you do not have Microsoft PowerPoint, download the
