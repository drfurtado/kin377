...
The decision to practice a skill as a whole or in parts can be based on the **complexity** and **organization** characteristics of the skill [@naylor1963a].
...
![](images/clipboard-326055546.png)
...
## Example: beam routine in gymnastics {.smaller}
...
## Example: Baseball pitching {.smaller}
...
-   If High in Organization --\> one [must]{.alert} use **Whole** because the parts are interconnected; else, either approach is ok.
-   If High in Complexity --\> one [must]{.alert} use **Part** because the parts are int erconnected; else, either approach is ok.
...
-   Method
    -   Fractionization is a part-practice strategy for skills requiring **asymmetric coordination (AC)**.
        -   What is AC?
...
-   Does it matter which limb to practice first?
    -   The **Complexity** of individual limb movements determines the [order of practice]{.underline}.
...
::: columns
::: {.column width="50%"}
![](images/clipboard-2007202392.png)
:::
...
::: columns
::: {.column width="50%"}
![](images/clipboard-2007232762.png)
:::
...
::: columns
::: {.column width="50%"}
![](images/clipboard-3926559675.png)
:::
...
::: columns
::: {.column width="50%"}
![](images/clipboard-3589833495.png)
:::
...
::: columns
::: {.column width="50%"}
![](images/clipboard-1429599350.png)
:::
