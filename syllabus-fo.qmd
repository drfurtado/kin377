...
Every week, you will be assigned one or more videos related to the topic assigned. To earn full `participation points` for the semester, you need to 1) watch each video in its entirely (from beginning to end) and 2) get a score of 100% on the included quiz.
