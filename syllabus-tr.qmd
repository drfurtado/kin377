...
subtitle: |
            ...
            Fall 2023 - Traditional (Face-to-Face)
            MW 12:30-1:45 p.m.
latex-auto-mk: true
format:
  html:
...
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |                                                                                            |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | **Contact Info\                                                                            |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | **Email: contact me via [Canvas Inbox](https://canvas.csun.edu/) (see @sec-e-mail-policy)\ |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Office: Redwood Hall 289\                                                                  |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Class meeting time: MW 12-30-1:45 p.m.                                                     |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------+
...
-   **25%**(11): [Quizzes](#sec-quizzes) \[SLO's 1\].
-   **25%**(3): [Exams](#sec-exams) \[SLO's 2\].
-   **15%**(1): [Learning Task Performance](#sec-lt-performance) (final video submission) \[SLO's 1, 2, 4\].
-   **15%**(1): [Learning Task Reflection] \[SLO's 1, 2, 4\].
-   **10%**(3): [Learning Task Updates] \[SLO's 1, 2, 4\].
-   **10%**: Participation

::: callout-note
One quiz with the lowest score will be dropped at the end of the term.
:::
...
::: callout-important
If you have any questions about assignments, deadlines, or any other course-related matters, please use the Q&A Forum in [Canvas](https://canvas.csun.edu). For any other queries, please send me an email through `Canvas Inbox`. **Kindly refrain from sending me an email at my CSUN email while taking this course as it is preferable to keep all communication related to the course separate from my CSUN email account.**
:::
...
`Participation` will be assessed in 3 ways:

1.  ~~Video completion rate~~
2.  Video knowledge check (embedded in each video)
3.  Roll call

Each week, you will be assigned one or more videos that relate to the topic given. To earn full `participation points` for the semester, you must complete the following: 1) watch each video in its entirety (from start to finish), 2) achieve a perfect score on the accompanying quiz, and 3) maintain perfect attendance.
