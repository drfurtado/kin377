...
6.  If you choose to obtain your materials elsewhere, you must opt out until **`9/22/23`** (see instructions below). Those who opt out by **`9/22/23`** will lose access and will **not be charged**.
7.  Anyone who does not Opt-Out by the **`9/22/23`** deadline will be charged, and those charges **will not be reversible**.
...
If you wish to opt out of this program and not purchase access to the required digital materials, you will need to follow the steps below by **`9/22/23`**:
